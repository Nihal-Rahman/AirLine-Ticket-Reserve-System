        ...
        <div className="searchFlights">          
            <Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validation}>
                <Form className='formContainer'>            
                    <label className='text-4xl'>Card Type:</label>
                    ...
                    <label className='text-4xl'>Name on Card:</label>
