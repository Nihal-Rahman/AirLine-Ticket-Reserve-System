...
function Flight(){
    ...
    return(
        <div className="ml-4 mt-40 text-2xl">
            <div className="text-center max-w-screen p-6 rounded-lg hover:shadow-2xl dark:bg-gray-800 dark:border-gray-700">
                <h1 className='w-42 underline decoration-sky-500 mb-2 text-4xl font-black tracking-tight text-gray-900 dark:text-white'>Flight {flight_num}</h1>
